...
export const PACKAGES: PackageDefinition[] = [
  {
    ...
    stripeDescription: 'Enthaltene Leistungen: 1 professionelle Webseite (One-Pager), eigene Domain inkl. SSL-Zertifikat, Hosting & Wartung inklusive, KI-gestützter Website-Editor mit Chatbot-Funktion zur eigenständigen Bearbeitung der Webseite, Kontaktformular mit Anfragen-Inbox, Spam-Schutz, mobile-optimiertes Responsive Design, DSGVO-Komplettpaket (Impressum, Datenschutzerklärung, Cookie-Banner). Laufende Betreuung & technischer Support inklusive.',
    setupFee: 0,
    seoLevel: 'basic',
    schemaOrg: false,
    seoArticles: 0,
