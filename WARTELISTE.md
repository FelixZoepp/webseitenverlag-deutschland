...
- [ ] **Maler B5 Optik-Freigabe**: 9 Screenshots (3 Stufen × Desktop/Mobile/Hero) in `docs/screenshots/maler/` — B2–B4 sind grün (test:maler 204, LH 100/92–95/100 auf allen 10 Seiten). Nach Freigabe setze ich `frozen:true` für `maler-landing-v1`; B6 (echte Assets) hängt zusätzlich am Higgsfield-Key
