...
- [ ] **Premium-Einordnung entscheiden**: 4. Produktstufe über Growth (Preis + Stripe-Preis-ID?) oder eigene Premium-Linie? `config/plans.ts` bewusst NICHT angefasst (`scroll_story` ist dort aktuell ein Growth-Editor-Feature). Außerdem: PV als Branche 17 in der Matrix oder Premium-Add-on für bestehende Branchen?
- [ ] **Seed-Musterdaten bestätigen**: „Solarflow" / Osnabrück / 0541 000000 als Musterbetrieb ok? Kontakt-Textarea-Placeholder „Kurz zu Ihrem Dach…" ist aktuell PV-hartkodiert — bei Branchen-Ausweitung konfigurierbar machen?
