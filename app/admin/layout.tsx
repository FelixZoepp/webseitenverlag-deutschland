      ...
      <div className="admin-layout" style={{ position: 'relative', zIndex: 1, display: 'grid', gridTemplateColumns: '240px 1fr', minHeight: '100vh' }}>
        ...
        <aside className="admin-sidebar">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            ...
            <Link href="/admin/support" className="sb-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" width="16" height="16"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
              Support
            </Link>
            <Link href="/admin/kennzahlen" className="sb-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" width="16" height="16"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
              Kennzahlen
            </Link>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            <div className="sb-section-label">Marketing</div>
            <Link href="/admin/marketing" className="sb-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" width="16" height="16"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
              Meta Ads
            </Link>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            ...
            <Link href="/admin/crm" className="sb-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" width="16" height="16"><rect x="3" y="3" width="5" height="18" rx="1"/><rect x="10" y="3" width="5" height="12" rx="1"/><rect x="17" y="3" width="5" height="8" rx="1"/></svg>
              CRM
            </Link>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            ...
            <Link href="/admin/branchen" className="sb-item">
